export const Add = () => (
  <svg height="48" width="48" viewBox="0 0 24 24" fill="none"  stroke="#00ff04">
...
export const Minus = () => (
  <svg height="48" width="48" fill="#6b6b6b" version="1.1" id="Capa_1" viewBox="0 0 30.334 30.334" xmlSpace="preserve">
    <g id="SVGRepo_bgCarrier" strokeWidth="0"></g>
    <g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g>
